...
namespace ProyekAI
{
    ...
    class Move
    {
        ...
        public Move(List<Stone> stones,Square start, Square end, int board, bool isPassive)
        {
        ...
        {
            return $"Player moved from {this.StartSquare} to {this.EndSquare} on {this.BoardMoveIsOn}.";
        }
    }
}
